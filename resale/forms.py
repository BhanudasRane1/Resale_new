...
from .models import sell_product,Inquiry
...
class inquiry_form(forms.ModelForm):
    class Meta:
        ...
        widgets = {
                'name':forms.TextInput(attrs={'class':'form-control',  'style': 'width: 50%  !important; resize: vertical !important; text-align: center;'}),
                'email':forms.TextInput(attrs={'class':'form-control', 'style': 'width: 50%  !important; resize: vertical !important;'}),
                'phone':forms.TextInput(attrs={'class':'form-control', 'style': 'width: 50%  !important; resize: vertical !important;'}),
                'desc':forms.TextInput(attrs={'class':'form-control', 'style': 'width: 50%  !important; resize: vertical !important;'}),
